...
<body>
	<%
		...
		try {
			...
			float inputSize=Float.parseFloat(request.getParameter("size"));
			...
			String str =  "SELECT a.apid, a.name, a.color, a.price, a.availability FROM apparel a, Shoes s WHERE a.apid = s.apid AND s.size = " + inputSize +" AND a.color LIKE " +"'"+ inputColor+"'";
		...
		if(result.next())
		{
			...
			out.print("No Shoes Available For given Preference");
			out.print("<br>");
			out.print("<br>");
		...
		out.print("<br><br><a href='shoesInput.jsp'>Return</a>");
		}
