...
<body>
	<%
		...
		try {
			...
			String str =  "SELECT a.apid, a.name, a.color, a.price, a.availability FROM apparel a, Shirts s WHERE a.apid = s.apid AND s.size LIKE " +"'"+ inputSize+ "'" +" AND a.color LIKE " +"'"+ inputColor+"'";
		...
		if(result.next())
		{
			...
			out.print("No Shirts Available For given Preference");
			out.print("<br>");
			out.print("<br>");
		...
		out.print("<br><br><a href='shirtInput.jsp'>Return</a>");
		}
